...
print("🚀 Launching Gantry-Stabilized Humanoid...")

with mujoco.viewer.launch_passive(model, data) as viewer:
    for i in range(2000):
        
       # A tiny hardcoded sequence in RADIANS to show it working safely:
        if i > 100:
            # Squat down slightly (meters)
            data.ctrl[15] = -0.2 
            
            # Arms forward (Radians! -0.8 rad is about -45 degrees)
            data.ctrl[1] = -0.8   
            data.ctrl[4] = -0.8
